...
commands[treatKey(locale.name)] = {
  ...
  solve: buildCharacterFieldSolver((c, i: { value: string }) => c.name = i.value),
};
...
commands[treatKey(locale.player)] = {
  ...
  solve: buildCharacterFieldSolver((c, i: { value: string }) => c.player = i.value),
};
...
commands[treatKey(locale.resonance.name)] = {
  ...
  solve: buildCharacterFieldSolver((c, i: { value: string }) => c.resonance = i.value),
};
...
commands[treatKey(locale.ambition)] = {
  ...
  solve: buildCharacterFieldSolver((c, i: { value: string }) => c.ambition = i.value),
};
...
commands[treatKey(locale.desire)] = {
  ...
  solve: buildCharacterFieldSolver((c, i: { value: string }) => c.desire = i.value),
};
...
commands[treatKey(locale.predator.name)] = {
  ...
  solve: buildCharacterFieldSolver((c, i: { value: string }) => c.predator = i.value),
};
...
commands[treatKey(locale.clan.name)] = {
  ...
  solve: buildCharacterFieldSolver((c, i: { value: string }) => c.clan = i.value),
};
...
commands[treatKey(locale.generation.name)] = {
  ...
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.generation = i.value),
};
...
commands[treatKey(locale.details)] = {
  ...
  solve: buildCharacterFieldSolver((c, i: { value: string }) => c.details = i.value),
};
...
commands[treatKey(locale.bloodPotency)] = {
  ...
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.bloodPotency = i.value),
};
...
commands[treatKey(locale.hunger)] = {
  ...
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.hunger = i.value),
};

commands[treatKey(locale.humanity)] = {
  description: `${locale.commands.sheet.description} ${locale.humanity}`,
  options: buildIntegerOptions(0, 10),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.humanity.total = i.value),
};

commands[treatKey(locale.stains)] = {
  description: `${locale.commands.sheet.description} ${locale.stains}`,
  options: buildIntegerOptions(0, 10),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.humanity.stains = i.value),
};
...
commands[treatKey(locale.attributes.physical.strength)] = {
  ...
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.attributes.physical.strength = i.value
  ),
};
...
commands[treatKey(locale.attributes.physical.dexterity)] = {
  ...
  options: buildIntegerOptions(1, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.attributes.physical.dexterity = i.value
  ),
};
...
commands[treatKey(locale.attributes.physical.stamina)] = {
  ...
  options: buildIntegerOptions(1, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.attributes.physical.stamina = i.value
  ),
};
...
commands[treatKey(locale.attributes.social.charisma)] = {
  ...
  options: buildIntegerOptions(1, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.attributes.social.charisma = i.value
  ),
};
...
commands[treatKey(locale.attributes.social.manipulation)] = {
  ...
  options: buildIntegerOptions(1, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.attributes.social.manipulation = i.value
  ),
};
...
commands[treatKey(locale.attributes.social.composure)] = {
  ...
  options: buildIntegerOptions(1, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.attributes.social.composure = i.value
  ),
};
...
commands[treatKey(locale.attributes.mental.intelligence)] = {
  ...
  options: buildIntegerOptions(1, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.attributes.mental.intelligence = i.value
  ),
};
...
commands[treatKey(locale.attributes.mental.wits)] = {
  ...
  options: buildIntegerOptions(1, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.attributes.mental.wits = i.value
  ),
};
...
commands[treatKey(locale.attributes.mental.resolve)] = {
  ...
  options: buildIntegerOptions(1, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.attributes.mental.resolve = i.value
  ),
};
...
commands[treatKey(locale.skills.physical.melee)] = {
  ...
  options: buildIntegerOptions(0, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.skills.physical.melee = i.value
  ),
};
...
commands[treatKey(locale.skills.physical.firearms)] = {
  ...
  options: buildIntegerOptions(0, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.skills.physical.firearms = i.value
  ),
};
...
commands[treatKey(locale.skills.physical.athletics)] = {
  ...
  options: buildIntegerOptions(0, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.skills.physical.athletics = i.value
  ),
};
...
commands[treatKey(locale.skills.physical.brawl)] = {
  ...
  options: buildIntegerOptions(0, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.skills.physical.brawl = i.value
  ),
};
...
commands[treatKey(locale.skills.physical.drive)] = {
  ...
  options: buildIntegerOptions(0, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.skills.physical.drive = i.value
  ),
};
...
commands[treatKey(locale.skills.physical.stealth)] = {
  ...
  options: buildIntegerOptions(0, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.skills.physical.stealth = i.value
  ),
};
...
commands[treatKey(locale.skills.physical.larceny)] = {
  ...
  options: buildIntegerOptions(0, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.skills.physical.larceny = i.value
  ),
};
...
commands[treatKey(locale.skills.physical.craft)] = {
  ...
  options: buildIntegerOptions(0, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.skills.physical.craft = i.value
  ),
};
...
commands[treatKey(locale.skills.physical.survival)] = {
  ...
  options: buildIntegerOptions(0, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.skills.physical.survival = i.value
  ),
};
...
commands[treatKey(locale.skills.social.animalKen)] = {
  ...
  options: buildIntegerOptions(0, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.skills.social.animalKen = i.value
  ),
};
...
commands[treatKey(locale.skills.social.etiquette)] = {
  ...
  options: buildIntegerOptions(0, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.skills.social.etiquette = i.value
  ),
};
...
commands[treatKey(locale.skills.social.intimidation)] = {
  ...
  options: buildIntegerOptions(0, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.skills.social.intimidation = i.value
  ),
};
...
commands[treatKey(locale.skills.social.leadership)] = {
  ...
  options: buildIntegerOptions(0, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.skills.social.leadership = i.value
  ),
};
...
commands[treatKey(locale.skills.social.streetwise)] = {
  ...
  options: buildIntegerOptions(0, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.skills.social.streetwise = i.value
  ),
};
...
commands[treatKey(locale.skills.social.performance)] = {
  ...
  options: buildIntegerOptions(0, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.skills.social.performance = i.value
  ),
};
...
commands[treatKey(locale.skills.social.persuasion)] = {
  ...
  options: buildIntegerOptions(0, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.skills.social.persuasion = i.value
  ),
};
...
commands[treatKey(locale.skills.social.insight)] = {
  ...
  options: buildIntegerOptions(0, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.skills.social.insight = i.value
  ),
};
...
commands[treatKey(locale.skills.social.subterfuge)] = {
  ...
  options: buildIntegerOptions(0, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.skills.social.subterfuge = i.value
  ),
};
...
commands[treatKey(locale.skills.mental.science)] = {
  ...
  options: buildIntegerOptions(0, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.skills.mental.science = i.value
  ),
};
...
commands[treatKey(locale.skills.mental.academics)] = {
  ...
  options: buildIntegerOptions(0, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.skills.mental.academics = i.value
  ),
};
...
commands[treatKey(locale.skills.mental.finance)] = {
  ...
  options: buildIntegerOptions(0, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.skills.mental.finance = i.value
  ),
};
...
commands[treatKey(locale.skills.mental.investigation)] = {
  ...
  options: buildIntegerOptions(0, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.skills.mental.investigation = i.value
  ),
};
...
commands[treatKey(locale.skills.mental.medicine)] = {
  ...
  options: buildIntegerOptions(0, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.skills.mental.medicine = i.value
  ),
};
...
commands[treatKey(locale.skills.mental.occult)] = {
  ...
  options: buildIntegerOptions(0, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.skills.mental.occult = i.value
  ),
};
...
commands[treatKey(locale.skills.mental.awareness)] = {
  ...
  options: buildIntegerOptions(0, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.skills.mental.awareness = i.value
  ),
};
...
commands[treatKey(locale.skills.mental.politics)] = {
  ...
  options: buildIntegerOptions(0, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.skills.mental.politics = i.value
  ),
};
...
commands[treatKey(locale.skills.mental.technology)] = {
  ...
  options: buildIntegerOptions(0, 5),
  solve: buildCharacterFieldSolver((c, i: { value: number }) => c.skills.mental.technology = i.value
  ),
};
