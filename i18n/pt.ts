...
export const pt: LocaleType = {
  ...
  disciplines: {
    ...
    oblivion: {
      ...
      oblivionsSight: "oblivionSight",
      shadowCloak: "shadowCloak",
      theBindingFeather: "theBindingFeather",
      fatalPrecognition: "fatalPrecognition",
      shadowCast: "shadowCast",
      armsOfAhriman: "armsofAhriman",
      whereTheShroudThins: "wheretheShroudThins",
      auraOfDecay: "auraOfDecay",
      passionFeast: "passionFeast",
      shadowPerspective: "shadowperspective",
      touchOfOblivion: "touchofOblivion",
      necroticPlague: "necroticPlague",
      stygianShroud: "stygianShroud",
      shadowStep: "shadowStep",
      skuldFulfilled: "skuldFulfilled",
      tenebrousAvatar: "tenebrousAvatar",
      witheringSpirit: "witheringSpirit",
    },
    presence: {
      name: "Presença",
      awe: "● Fascínio",
  ...
  actions: [
    ...
    "{Animalismo} ● Sentir a Besta [Raciocínio + Animalismo]",
    "{Animalismo} ● Famulus Enlaçado [Carisma + Empatia com Animais]",
    "{Animalismo} ●● Sussurros Selvagens [Manipulação + Animalismo]",
    "{Animalismo} ●●● Domar a Besta [Carisma + Animalismo]",
    "{Animalismo} ●●●● Subordinar o Espírito [Manipulação + Animalismo]",
    "{Animalismo} ●●●●● Domínio Animal [Carisma + Animalismo]",
    "{Animalismo} ●●●●● Extrair a Besta [Inteligência + Animalismo]",
    "{Dominação} ● Compelir [Carisma + Dominação]",
    "{Dominação} ● Nublar a Memória [Carisma + Dominação]",
    "{Dominação} ●● Mesmerizar [Manipulação + Dominação]",
    "{Dominação} ●● Demência [Manipulação + Dominação]",
    "{Dominação} ●●● A Mente Esquecida [Manipulação + Dominação]",
    "{Dominação} ●●●● Racionalizar [Inteligência + Dominação]",
    "{Dominação} ●●●●● Possessão [Raciocínio + Dominação]",
    ...
    "{Presença} ●●●● Convocação [Manipulação + Presença]",
    "{Presença} ●●●●● Majestade [Carisma + Presença]",
    "{Auspícios} ● Sentidos Aguçados [Raciocínio + Auspícios]",
    "{Auspícios} ● Sentir o Não Visto [Raciocínio + Auspícios]",
    "{Auspícios} ●● Premonição [Raciocínio + Auspícios]",
    "{Auspícios} ●●● Compartilhar os Sentidos [Raciocínio + Auspícios]",
    "{Auspícios} ●●● Sondar a Alma [Inteligência + Auspícios]",
    "{Auspícios} ●●●● Toque do Espírito [Inteligência + Auspícios]",
    "{Auspícios} ●●●●● Clarividência [Inteligência + Auspícios]",
    "{Auspícios} ●●●●● Telepatia [Raciocínio + Auspícios]",
    "{Celeridade} ●● Rapidez [Destreza + Atletismo]",
    "{Celeridade} ●●● Piscar [Destreza + Atletismo]",
    "{Celeridade} ●●● Travessia [Destreza + Atletismo]",
    "{Celeridade} ●●●●● Movimento Relâmpago [Destreza + Atletismo]",
    "{Fortitude} ●● Vigor Inabalável [Vigor + Fortitude]",
    "{Fortitude} ●●● Desafiar a Maldade [Vigor + Fortitude]",
    "{Fortitude} ●●●●● Proeza da Dor [Vigor + Fortitude]",
    "{Potência} ● Golpe Poderoso [Força + Briga]",
    "{Potência} ●● Salto Impressionante [Força + Esportes]",
    "{Potência} ●● Resiliência Física [Força + Briga]",
    "{Potência} ●●● Golpe Demolidor [Força + Briga]",
    "{Potência} ●●● Investida Brutal [Força + Esportes]",
    "{Potência} ●●●● Dominação Física [Força + Briga]",
    "{Potência} ●●●● Impacto Devastador [Força + Briga]",
    "{Potência} ●●●●● Devastação Total [Força + Briga]",
    "{Potência} ●●●●● Rasgo Colossal [Força + Briga]",
    "{Ofuscação} ● Sombra Silenciosa [Raciocínio + Furtividade]",
    "{Ofuscação} ●● Máscara de Mil Faces [Raciocínio + Furtividade]",
    "{Ofuscação} ●● Ilusão Simples [Raciocínio + Manipulação]",
    "{Ofuscação} ●●● Passo Invisível [Manipulação + Furtividade]",
    "{Ofuscação} ●●●● Escudo de Sombras [Manipulação + Ofuscação]",
    "{Ofuscação} ●●●● Silêncio Perfeito [Raciocínio + Furtividade]",
    "{Ofuscação} ●●●●● Desaparecimento Total [Raciocínio + Furtividade]",
    "{Ofuscação} ●●●●● Véu Coletivo [Manipulação + Ofuscação]",
    "{Feitiçaria de Sangue} ● Rituais Básicos [Inteligência + Ocultismo]",
    "{Feitiçaria de Sangue} ●● Moldar Sangue [Raciocínio + Ocultismo]",
    "{Feitiçaria de Sangue} ●●● Maldição do Sangue [Raciocínio + Ocultismo]",
    "{Feitiçaria de Sangue} ●●●● Criar Vinculum [Raciocínio + Ocultismo]",
    "{Feitiçaria de Sangue} ●●●●● Ritual Supremo [Inteligência + Ocultismo]",
    "{Feitiçaria de Sangue} ●●●●● Drenar Força [Inteligência + Ocultismo]",
    "{Feitiçaria do Sangue} Rituais [Raciocínio + Ocultismo]",
  ],
};
