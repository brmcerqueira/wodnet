...
import { MasterView, Dots, Damage, DualMeter, Square, XSquare, Humanity } from "./masterView.tsx";
...
export const VampireView = (character: Character, token: string, dark: boolean, update: number): TsxComplexElement => {
  return <MasterView character={character} token={token} dark={dark} update={update}>
    <div class="container">
    ...
    <div class="container">
      ...
      <div class="row">
        {keys(character.disciplines).map(key => <div class="col-sm-4 mb-5">
          <div class="row align-items-center mb-2">
