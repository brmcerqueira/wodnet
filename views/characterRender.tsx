            ...
            <div class="container">
                <div class="row align-items-end mt-2">
                    ...
                    <div class="col-sm-3 mb-2">
                        <div class="row align-items-center tooltip" data-tooltip={character.name}>
                            <div class="col text-end"><b>{locale.name}:</b></div>
                            <div class="col text-start overflow-ellipsis">{character.name}</div>
                        </div>
                        <div class="row align-items-center tooltip" data-tooltip={character.player}>
                    ...
                    <div class="col-sm-3 mb-2">
                        ...
                        <div class="row align-items-center tooltip" data-tooltip={character.ambition}>
                            <div class="col text-end"><b>{locale.ambition}:</b></div>
                            <div class="col text-start overflow-ellipsis">{character.ambition}</div>
                        </div>
                        <div class="row align-items-center tooltip" data-tooltip={character.desire}>
