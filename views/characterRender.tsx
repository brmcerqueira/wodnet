                ...
                <div class="row align-items-end mt-2">
                    ...
                    <div class="col-sm-3 mb-2">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col text-start">{character.experience.total}({locale.experience.total}) - {character.experience.spent}({locale.experience.spent}) = {character.experience.total - character.experience.spent}</div>
                        </div>
                    </div>
                    <div class="col-sm-3 mb-2">
                        <div class="row align-items-center">
