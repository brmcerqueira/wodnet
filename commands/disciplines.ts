...
commands[treatKey(locale.disciplines.animalism.name)] = {
  ...
  solve: buildCharacterUpdateSolver(disciplineParse("animalism", getMultiplier)),
...
commands[treatKey(locale.disciplines.bloodSorcery.name)] = {
  ...
  solve: buildCharacterUpdateSolver(disciplineParse("bloodSorcery", getMultiplier)),
...
commands[treatKey(locale.disciplines.fortitude.name)] = {
  ...
  solve: buildCharacterUpdateSolver(disciplineParse("fortitude", getMultiplier)),
...
commands[treatKey(locale.disciplines.obfuscate.name)] = {
  ...
  solve: buildCharacterUpdateSolver(disciplineParse("obfuscate", getMultiplier)),
...
commands[treatKey(locale.disciplines.thinBloodAlchemy.name)] = {
  ...
  solve: buildCharacterUpdateSolver(disciplineParse("thinBloodAlchemy", () => 3)),
