...
commands[treatKey(locale.attributes.physical.strength)] = {
  ...
  solve: buildCharacterUpdateSolver(
    parseNumberFieldWithSpent((c) =>
      c.attributes.physical.strength, (c, v) =>
      c.attributes.physical.strength = v, multiplier),
    false,
  ),
};
commands[treatKey(locale.attributes.physical.dexterity)] = {
  ...
  solve: buildCharacterUpdateSolver(
    parseNumberFieldWithSpent((c) =>
      c.attributes.physical.dexterity, (c, v) =>
      c.attributes.physical.dexterity = v, multiplier),
    false,
  ),
};
commands[treatKey(locale.attributes.physical.stamina)] = {
  ...
  solve: buildCharacterUpdateSolver(
    parseNumberFieldWithSpent((c) =>
      c.attributes.physical.stamina, (c, v) =>
      c.attributes.physical.stamina = v, multiplier),
    false,
  ),
};
commands[treatKey(locale.attributes.social.charisma)] = {
  ...
  solve: buildCharacterUpdateSolver(
    parseNumberFieldWithSpent((c) =>
      c.attributes.social.charisma, (c, v) =>
      c.attributes.social.charisma = v, multiplier),
    false,
  ),
};
commands[treatKey(locale.attributes.social.manipulation)] = {
  ...
  solve: buildCharacterUpdateSolver(
    parseNumberFieldWithSpent((c) =>
      c.attributes.social.manipulation, (c, v) =>
      c.attributes.social.manipulation = v, multiplier),
    false,
  ),
};
commands[treatKey(locale.attributes.social.composure)] = {
  ...
  solve: buildCharacterUpdateSolver(
    parseNumberFieldWithSpent((c) =>
      c.attributes.social.composure, (c, v) =>
      c.attributes.social.composure = v, multiplier),
    false,
  ),
};
commands[treatKey(locale.attributes.mental.intelligence)] = {
  ...
  solve: buildCharacterUpdateSolver(
    parseNumberFieldWithSpent((c) =>
      c.attributes.mental.intelligence, (c, v) =>
      c.attributes.mental.intelligence = v, multiplier),
    false,
  ),
};
commands[treatKey(locale.attributes.mental.wits)] = {
  ...
  solve: buildCharacterUpdateSolver(
    parseNumberFieldWithSpent((c) =>
      c.attributes.mental.wits, (c, v) =>
      c.attributes.mental.wits = v, multiplier),
    false,
  ),
};
commands[treatKey(locale.attributes.mental.resolve)] = {
  ...
  solve: buildCharacterUpdateSolver(
    parseNumberFieldWithSpent((c) =>
      c.attributes.mental.resolve, (c, v) =>
      c.attributes.mental.resolve = v, multiplier),
    false,
  ),
};
