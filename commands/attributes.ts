...
commands[treatKey(locale.attributes.physical.strength)] = {
  ...
  solve: buildCharacterSolver(parseNumberField(c => c.attributes.physical.strength, (c, v) => c.attributes.physical.strength = v, multiplier)
  ),
};
commands[treatKey(locale.attributes.physical.dexterity)] = {
  ...
  options: buildIntegerOptions(1, 5),
  solve: buildCharacterSolver(parseNumberField(c => c.attributes.physical.dexterity, (c, v) => c.attributes.physical.dexterity = v, multiplier)
  ),
};
commands[treatKey(locale.attributes.physical.stamina)] = {
  ...
  options: buildIntegerOptions(1, 5),
  solve: buildCharacterSolver(parseNumberField(c => c.attributes.physical.stamina, (c, v) => c.attributes.physical.stamina = v, multiplier)
  ),
};
commands[treatKey(locale.attributes.social.charisma)] = {
  ...
  options: buildIntegerOptions(1, 5),
  solve: buildCharacterSolver(parseNumberField(c => c.attributes.social.charisma, (c, v) => c.attributes.social.charisma = v, multiplier)
  ),
};
commands[treatKey(locale.attributes.social.manipulation)] = {
  ...
  options: buildIntegerOptions(1, 5),
  solve: buildCharacterSolver(parseNumberField(c => c.attributes.social.manipulation, (c, v) => c.attributes.social.manipulation = v, multiplier)
  ),
};
commands[treatKey(locale.attributes.social.composure)] = {
  ...
  options: buildIntegerOptions(1, 5),
  solve: buildCharacterSolver(parseNumberField(c => c.attributes.social.composure, (c, v) => c.attributes.social.composure = v, multiplier)
  ),
};
commands[treatKey(locale.attributes.mental.intelligence)] = {
  ...
  options: buildIntegerOptions(1, 5),
  solve: buildCharacterSolver(parseNumberField(c => c.attributes.mental.intelligence, (c, v) => c.attributes.mental.intelligence = v, multiplier)
  ),
};
commands[treatKey(locale.attributes.mental.wits)] = {
  ...
  options: buildIntegerOptions(1, 5),
  solve: buildCharacterSolver(parseNumberField(c => c.attributes.mental.wits, (c, v) => c.attributes.mental.wits = v, multiplier)
  ),
};
commands[treatKey(locale.attributes.mental.resolve)] = {
  ...
  options: buildIntegerOptions(1, 5),
  solve: buildCharacterSolver(parseNumberField(c => c.attributes.mental.resolve, (c, v) => c.attributes.mental.resolve = v, multiplier)
  ),
};
